...
public final class Utility {
    ...
    public static Bitmap getMarkerBitmapFromView(Context context, int recourceId) {
        DisplayMetrics metrics = context.getResources().getDisplayMetrics();
        int width = metrics.widthPixels;
        int height = metrics.heightPixels;

        View customMarkerView = LayoutInflater.from(context).inflate(recourceId, null);
    ...
    public static Bitmap getMarkerBitmapFromView(Context context, View customMarkerView) {
        DisplayMetrics metrics = context.getResources().getDisplayMetrics();
        int width = metrics.widthPixels;
        int height = metrics.heightPixels;
